package dev.bmcreations.expiry.base.extensions
...
val Date.weekday: Weekday
    get() = Weekday.fromPosition(
        dayOfWeek
    )
fun Date.isSunday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Sunday
fun Date.isMonday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Monday
fun Date.isTuesday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Tuesday
fun Date.isWednesday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Wednesday
fun Date.isThursday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Thursday
fun Date.isFriday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Friday
fun Date.isSaturday(): Boolean = Weekday.fromPosition(
    dayOfWeek
) == Weekday.Saturday
